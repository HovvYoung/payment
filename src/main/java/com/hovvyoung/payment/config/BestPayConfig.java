package com.hovvyoung.payment.config;
...
public class BestPayConfig {
    ...
    public BestPayService bestPayService() {
        ...
        wxPayConfig.setNotifyUrl("http://4um2ce.natappfree.cc/pay/notify");
        ...
        aliPayConfig.setNotifyUrl("http://4um2ce.natappfree.cc/pay/notify");
